...
public class TestPatternHopFactory extends TestCase {
    ...
    public void testTransfers() throws Exception {
        ...
        assertEquals(StopTransfer.UNKNOWN_TRANSFER, transferTable.getTransferTime(null, stopN, stopM, fromTrip, toTrip, true));
        assertEquals(StopTransfer.FORBIDDEN_TRANSFER, transferTable.getTransferTime(null, stopK, stopM, fromTrip, toTrip, true));
        assertEquals(StopTransfer.PREFERRED_TRANSFER, transferTable.getTransferTime(null, stopN, stopK, toTrip, toTrip2, true));
        assertEquals(StopTransfer.TIMED_TRANSFER, transferTable.getTransferTime(null, stopN, stopK, fromTrip, toTrip, true));
        assertEquals(15, transferTable.getTransferTime(null, stopN, stopK, fromTrip, toTrip2, true));
